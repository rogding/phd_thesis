...
The experimental procedures used for the following experiments are similar and will only be briefly covered.
Similar to other experiments with ultracold strontium atoms, a two-stage cooling process was used where a blue MOT followed by a red MOT produced samples with $T \simeq \SI{2}{\micro\kelvin}$.
These atoms were then loaded in to an ODT.

*****************************


For the fermions, \Sr{87} was used in both a spin-polarized and unpolarized states. 
In the spin-polarized case, all the \Sr{87} atoms were optically pumped to the $\nSLJfm{5s^2}{1}{S}{0}{{9}/{2}}{{9}/{2}}$ stretched state before performing two-photon Rydberg excitation.
An unpolarized gas of \Sr{87} approximates a classical gas.
In the unpolarized case, no optical pumping was performed and the \Sr{87} atoms were approximately equally distributed across the $\num{10}$ $m_F$ spin states .

For bosonic gases, \Sr{84} was used because it evaporates well. 
It's important to note that evaporation of \Sr{84} was stopped before reaching quantum degeneracy as that leads to ${g}^{\pqty{2}}_{\text{BEC}}\pqty{R} = 1$.
