...
Although it would be extremely useful to know the exact value of the electron detection efficiency $\alpha$, only the ratio ${\alpha_{\text{pol}}}/{\alpha_{\text{unpol}}}$ is needed since we are interested in comparing signals spin-polarized and unpolarized samples.
...
\subsection{Comparison of $\mathcal{S}_{n}^{\nu}$ to $\mathcal{S}_{n}^{\nu}$}

**** BETTER SECTION TITLE ****

Out of curiosity, we quickly looked at the....
