...
Photoexcitation to a particular ULRRM state, with wave function $\ket*{\chi_{n}^{\nu}}$, requires $\abs*{\bra*{\chi^{E}_{0}}\ket*{\chi_{n}^{\nu}}}^{2}$ which can be thought of as a Franck-Condon factor.
...
\begin{equation}
	...
	\mathcal{F}_{n}^{\nu}	=	\ev{\abs{\bra{\chi^{E}_{0}}\ket{\chi_{n}^{\nu}}}^{2}}_{E}
...
\begin{align}
	...
	\mathcal{F}_{n}^{\nu}	{}&=	\ev{\abs{\int_{0}^{\infty} \dd{R} {R^2} \chi^{E}_{0}\pqty{R} \chi_{n}^{\nu=0}\pqty{R}}^2}_{E}
