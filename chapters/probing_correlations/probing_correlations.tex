...
The $\SI{689}{\nm}$ photon is blue-detuned of intermediate $\nSLJf{5s5p}{3}{P}{1}{{11}/{2}}$ state.
In order to increase signal, $\pi-\pi$ measurements are performed $\num{1000}$ times before before a new sample is loaded.
...
\begin{figure}[!htbp]
	...
	\caption[]{
		...
		The small features on the extreme left and right are likely due to imperfect polarization of the first photon.}
\end{figure}
From the fitted amplitudes, the spin-polarization scheme achieves $\SI{> 90}{\percent}$ population in the $\nSLJfm{5s^2}{1}{S}{0}{{9}/{2}}{{9}/{2}}$ state.
The repeated $\pi-\pi$ excitations does cause some redistribution of the population among the $\nSLJfM{5s^2}{1}{S}{0}{{9}/{2}}{m_F}$ states so it places a lower bound on the effectiveness of spin-polarization to the $\nSLJfm{5s^2}{1}{S}{0}{{9}/{2}}{{9}/{2}}$ state.

After spin-polarization, forced evaporation is performed and the bias magnetic field is ramped down to about $\SI{1}{\gauss}$. 
...
In order to eliminate any dependency of $\mathcal{S}_{n}^{\nu}$ on the detection efficiency, polarized signals were compared to polarized signals and unpolarized signals were compared to unpolarized signals within a principal quantum number.
...
\end{figure}
The ratios of the $\nu = 1$ vibrational state compared to the $\nu = 0$ state follow the na{\"{i}}ve expectation that they should exhibit additional suppression due to extending towards smaller $n$ that corresponds to smaller interparticle separations. 
The $\nu = 2$ to $\nu = 0$ ratio is counterintuitive and suggests that it is easier to excite the delocalized $\nu = 2$ state at smaller $n$ (i.e., smaller interparticle separations) compared to at larger $n$. 
