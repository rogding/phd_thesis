...
For \Sr{87}, the hyperfine shifts for each state was calculated by Shuhei Yoshida and were subtracted from the measured term energies to obtain the quantum defect for an effective $I = 0$ atom.
\begin{SingleSpace}
...
Since the measured quantum defects of the $\nSLJ{5snd}{1}{D}{2}$ series in \Sr{88} was available up to $n = 84$ \cite{Beigang1982.OC.42.19}, the quantum defects from \cite{Vaillant2012.JPB.45.135004} were used for these states. 
...
A theoretical fit to the data is also shown in \Cref{fig:spectra-n50,fig:spectra-n60,fig:spectra-n98} which was determined 
