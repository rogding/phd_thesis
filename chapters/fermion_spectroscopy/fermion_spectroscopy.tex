...
** More explicitly work out how the approximation in the equation above leads to the one below? **
For a singly-excited Rydberg state where the Rydberg electron is in the $\ket{n \ell}$ state while the inner electron remains in the $\ket{m s}$ state, we write the approximate Hamiltonian as \cite{Beigang1983.PRL.51.771, Beigang1988.JOSAB.5.2423}
\begin{equation}
	\hat{H} = \hat{H}_{0} + \hat{H}_{\text{fs}} + \zeta_{nl} \hat{\va{s}} \vdot \hat{\va{l}} + a_{ms} \hat{\va{s}} \vdot \hat{\va{I}}
\end{equation}
