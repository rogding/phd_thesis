...
\end{equation}
For singly-excited Rydberg states with the ``inner'' electron in the $\ket{m s}$ state (i.e., an $s$ electron in the ground state of the ion) and the ``outer'' Rydberg electron in the $\ket{n \ell}$ state, we expect the hyperfine contributions from them to be
\begin{align}
	asdf	&{}={}
\end{align}
