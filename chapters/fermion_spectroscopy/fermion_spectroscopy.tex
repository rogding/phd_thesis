...
\begin{figure}[htbp]
	...
	\caption{
		...
		Measured and predicted spectra for {$D$~states} near ${n=50}$. 
		The energies are plotted relative to the $\nSLJf{5s50s}{3}{S}{1}{11/2}$ state.}
\end{figure}
...
\begin{figure}[htbp]
	...
	\caption{
		...
		Measured and predicted spectra for {$D$~states} near ${n=60}$. 
		The energies are plotted relative to the $\nSLJf{5s60s}{3}{S}{1}{11/2}$ state.
		The $\nSLJf{5s60s}{3}{S}{1}{11/2}$ signal was scaled $\flatfrac{1}{10}$.}
\end{figure}
...
\begin{figure}[htbp]
	...
	\caption{
		...
		Measured and predicted spectra for {$D$~states} near ${n=98}$. 
