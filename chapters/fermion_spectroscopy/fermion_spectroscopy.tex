...
The first indication that the Rydberg levels of \Sr{87} was not as simple as for the bosonic isotopes was that the reported ionization limit of \SI{45932.2861(10)}{\per\cm} \cite{bei1982.OC.42.19,san2010.JPCRD.39.033103} for \Sr{87} is well above that of all the bosonic isotopes (see \cref{tab:sr_nuc_prop}). 
Using the ionization limits for the bosons and the atomic masses of the isotopes, a mass-scaled ionization limit for an assumed $I=0$ \Sr{87} can be estimated to be **\SI{45932.19870+-0.00035}{\per\cm}**. 
