...
Experimental and theoretical studies of the spectrum for \Sr{87} have also been reported \cite{Beigang1981.PRL.47.326, Beigang1982.PRL.48.290, Beigang1982.PRA.25.1496, Beigang1983.PRL.51.771, beig88, Sun1989.JPB.22.2887}. 
...
Using the measured quantum defects for \Sr{88} \cite{Beigang1982.OC.42.19, Beigang1982.PS.26.183} and the Rydberg-Ritz formula, the hyperfine structure is calculated and plotted in terms of quantum defects (see Fig.~\ref{fig:shiftD}). 
...
\end{equation}
and the values of $\mu_{0}$, $\alpha$, and $\beta$ given in Table~\ref{tab:delta}, which also includes the corresponding values derived from the earlier measurements at lower $n$ \cite{Vaillant2012.JPB.45.135004}. 
...
\begin{figure}[!htbp]
	...
	\caption{\label{fig:Rydberg-Ritz-S} (Color online.)
		Quantum defects $\mu^{(0)}_{n,S,L,J}$ for the $\nSLJ{5sns}{3}{S}{1}$ levels: ($\bullet$) measurements from earlier work \cite{Beigang1982.OC.42.19,Beigang1982.PS.26.183}, ({\color{red} $\blacktriangle$}) present measurements of the $\nSLJf{5sns}{3}{S}{1}{11/2}$ states derived from the earlier ionization limit \cite{Sansonetti2010.JPCRD.39.033103}, ({\color[rgb]{0,1,1} $\blacktriangledown$}) present measurements with modified ionization limit (see text).
		({\color{green}\dashedline}) predictions using the Rydberg-Ritz formulas from \cite{Vaillant2012.JPB.45.135004} and ({\color{blue}\solidline}) the modified Rydberg-Ritz formulas.
