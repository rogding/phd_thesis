...
The second valence electron introduces additional complexity (``richness'') as well due to there being multiple Rydberg series which can interact and perturb each other. 
...
For the bosons, the lack of nuclear spin means there is no hyperfine structure which greatly simplifies their Rydberg spectra whereas the hyperfine structure of \Sr{87} makes the spectra significantly more complicated. 
...
It was observed that the lifetimes of rubidium ULRRMs were significantly shorter than the parent Rydberg atom lifetime which was attributed to a $p$-wave scattering resonance \cite{Butscher2011.JPB.44.184004, Hamilton2002.JPB.35.L199}.
In contrast, strontium ULRRMs exhibit similar lifetimes to the parent Rydberg atoms, indicating much weaker (or absent) $p$-wave scattering resonance \cite{Camargo2016.PRA.93.022702}.
It should be noted that in very dense gases (i.e., in a BEC), even strontium ULRRMs exhibit reduced lifetimes with the effect being attributed to collisions between ground-state atoms and the Rydberg core ion \cite{Whalen2017.PRA.96.042702}.

\section{Thesis Outline}

**** QUICK THESIS OUTLINE SECTION? ****