...
Talk about binding energy, Rydberg formula, etc. 

****

Since the principal quantum number greatly affects the atomic wave function, it also sets the energy scale for many interactions and therefore the properties of Rydberg atoms become exaggerated when $n$ becomes large.
