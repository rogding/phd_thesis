...
A ``trimer'' is one (1) Rydberg atom and two (2) ground-state atoms, a ``tetramer'' is one (1) Rydberg atom and three (3) ground-state atoms, and so on (e.g., see \cite{Bendkowsky2010.PRL.105.163201}).
