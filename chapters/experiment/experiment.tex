...
The blue MOT coils are constructed from square tubular wires\footnote{S{\&}W Wire 125SQ DPG/BARE (NEMA 46-C).} which are hollow inside for cooling water.
We typically run the blue MOT coils with around $\SIrange[range-phrase=-]{40}{50}{\ampere}$ of from a power supply\footnote{TDA-Lambda *** ADD MODEL ***} set for fixed-current output. 
