...
\Cref{tab:blue_isotope_shift} gives the isotope shifts for the various transitions in strontium referenced to \Sr{88}.
\begin{table}[h]
	\caption[]{
...
The magnetic trap are also crucial for laser cooling and trapping multiples isotopes. 
...
The key to trapping multiple isotopes is to utilize the automatic accumulation of $\SLJ{3}{P}{2}$ atoms in the ma, which is dark to the $\SI{461}{\nm}$ cooling light, in the magnetic trap. 

************************

************************

Multiple isotopes can be stored in the magnetic trap simply by operating a blue MOT for that specific isotope before changing the laser frequency to efficiently trap a different isotope. 
...
Several transitions have been explored for repumping atoms out of the metastable reservoir, each of which has varying challenges and benefits \cite{Courtillot2005.EPJD.33.161, Boyd2007.PhD, Ludlow2008.PhD, Barker2015.PRA.92.043418, Campbell2017.PhD, Cooper2018.PRX.8.041055, Mickelson2009.JPB.42.235001, Stellmer2013.PhD, Stellmer2014.PRA.90.022512, Moriya2018.JPC.2.125008, Mason2013.BS, Stellmer2014.PRA.90.022512, Moriya2018.JPC.2.125008, Wongwaitayakornkul2013.BS, Camargo2015.MS, Ding2016.MS, Couturier2018.RSI.89.043103, Hu2019.PRA.99.033422}\footnote{\cite{Stellmer2013.PhD} gives an excellent overview for most of the repumping transitions explored.}.
On our experiment, we use the $\SI{481}{\nm}$ transition which drives $\nSLJ{5s5p}{3}{P}{2} \rightarrow \nSLJ{5p^2}{3}{P}{2}$.
One of the main advantages of this transition is that the upper state is $\SLJ{3}{P}{2}$ meaning it only requires a single laser to clear out the magnetic trap since the $\nSLJ{5p^2}{3}{P}{2}$ can only decay to either the $\nSLJ{5s5p}{3}{P}{1}$ or $\nSLJ{5s5p}{3}{P}{2}$ states. 
Another advantage of this transition is that the hyperfine structure of the doubly-excited $\nSLJ{5p^2}{3}{P}{2}$ is expected to be small meaning the hyperfine shift should be predominantly due to the $\nSLJ{5s5p}{3}{P}{2}$ state. 

The magnetic trap and repumper system are also essential for laser cooling and trapping multiple isotopes for experiments requiring sympathetic cooling, Bose-Bose, or Bose-Fermi mixtures where it's challenging to cool and trap multiple isotopes simultaneously with the $\SI{461}{\nm}$ transition due to the isotope shift (see \cref{tab:blue_isotope_shift}) being comparable to the linewidth. 
Multiple isotope trapping is achieved by first loading the magnetic trap with a single isotope by simply operating a blue MOT for that isotope. Before turning off the blue MOT coils, the laser frequency is changed to operate a blue MOT for a different isotope which also gets loaded in to the magnetic trap. 
All the atoms from the magnetic trap can be recovered with a single repumper laser with frequencies appropriate for addressing the isotopes in the magnetic trap.
...
Multiple bosonic red MOTs are particularly easy since they all exhibit similar spatial profiles whereas the fermionic isotope is a bit trickier. 
...
This section of the vacuum chamber is where strontium oven and 2D collimator are located and produces the atomic beam of strontium for cooling and trapping.
Although there are various designs for strontium ovens \cite{Senaratne2015.RSI.86.023105, Schioppo2012.RSI.83.103101}, and even commercial systems, we used a simple design which has shown success on the older strontium experiments in the lab.
