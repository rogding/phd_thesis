...
\begin{sidewaysfigure}[htbp]
	\centering
	\includesvg[keepaspectratio=true, width=\paperwidth, height=\paperheight]{blue_MOT_system.svg}
	\caption{\label{fig:blue_MOT_system}**Placeholder**Simplified diagram of the blue MOT system.}
\end{sidewaysfigure}
...
\begin{figure}[htbp]
	\centering
	\includesvg[keepaspectratio=true, width=\textwidth, height=\textheight]{uv_system.svg}
