...
\begin{description}
	...
	\item[Optical trapping and evaporative cooling] \hfill \\
		...
		Optical dipole traps work by inducing energy shifts of atomic sates via off-resonantly coupling and, therefore, require high powers to achieve sufficient trap depths. 
...
\end{description}
Detailed explanations of the various techniques and a variety of setups are available from numerous sources (e.g., see \cite{Boyd2007.PhD, Mickelson2010.PhD, Martinez2012.PhD, Millen2011.PhD, Stellmer2013.PhD, Boddy2014.PhD, Barker2016.PhD, Campbell2017.PhD}).
...
\begin{figure}[!htbp]
	...
	\caption[]{
		...
		With the electric field plates separated by about $\SI{1}{\inch}$, this blue MOT likely has a vertical height close to $\SI{0.5}{\inch}$.}
\end{figure}
...
Although the $\SI{461}{\nm}$ light is capable of scattering many photons per second, the Doppler limit of this transition is about $T_{D} = \SI{732}{\micro\kelvin}$\footnote{For the $\SI{461}{\nm}$ transition: $k_{B} T_{D} \equiv \flatfrac{\hbar \Gamma}{2} = \SI{732}{\micro\kelvin}$, $k_{B} T_{r} \equiv \flatfrac{\hbar^2 k^2}{2 M} = \SI{512}{\nano\kelvin}$.} \cite{Metcalf1999.LCT} with typical temperatures closer to $\SI{1}{\milli\K}$.
While sub-Doppler cooling is not available in the bosonic isotopes, it has been observed in \Sr{87} where the blue MOT temperature was measured to be about $\SI{300}{\micro\kelvin}$ \cite{Xu2003.PRL.90.193002, Xu2003.JOSAB.20.968}.
