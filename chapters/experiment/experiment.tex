...
This chapter describes the Rydberg apparatus used in this thesis with the purpose of providing an overview of the current state of various systems for producing ultracold and quantum degenerate gases of strontium as well as providing references which may be helpful for future upgrades. 
...
Although our system looks very similar to other ultracold strontium experiments, what makes our system uniquely suited for studying Rydberg physics is the inclusion of systems for creating, manipulating, and detecting charged particles. 
...
Detailed explanations of the various techniques and a variety of setups are available from numerous sources (e.g., see \cite{Boyd2007.PhD, Mickelson2010.PhD, Martinez2012.PhD, Millen2011.PhD, Stellmer2013.PhD, Boddy2014.PhD, Barker2016.PhD, Campbell2017.PhD}) so the process will only be outlined here. 
...
\begin{description}
	\item[Cooling and trapping on the $\nSLJ{5s^2}{1}{S}{0} \rightarrow \nSLJ{5s5p}{1}{P}{1}$ transition] \hfill \\
		This broad ${\Gamma}/{2\pi} = \SI{30.5}{\MHz}$ transition at $\SI{461}{\nm}$ is used for the first stage of cooling due its ability to scatter many photons very rapidly, exerting large radiative forces on the atoms. 
	...
	\item[Cooling and trapping on the $\nSLJ{5s^2}{1}{S}{0} \rightarrow \nSLJ{5s5p}{3}{P}{1}$ transition] \hfill \\
		...
		Due to the narrower linewidth, the $\SI{689}{\nm}$ transition scatters far fewer photons than the $\SI{461}{\nm}$ transition, making it unsuitable for capturing large numbers of atoms from a thermal source.
...
\Cref{tab:sr_scattering_lengths_long} lists the $s$-wave scattering lengths for various combinations of isotopes. 
\begin{table}[!htbp]
	\caption[]{
		\label{tab:sr_scattering_lengths_long}
		Measured $s$-wave scattering lengths ($a_s$) of strontium for various pairs of isotopes. 
		Scattering lengths are given in [$\si{\bohr}$].}
	\centering
	\begin{tabular}{@{}cccc@{}}
		\toprule
