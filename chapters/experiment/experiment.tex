...
Although the primary signals of interest are obtained from the charged-particle detection system, absorption imaging\footnote{Our primary absorption imaging camera is an Andor Luca-R DL-604M-OEM.} remains an important diagnostic tool for measuring the atom number and sample temperature.
...
The sample temperature can be extracted by performing a ``time-of-flight'' measurement by introducing a delay between releasing the atoms from the trap and the imaging pulses \cite{Yavin2002.AJP.70.149}.
...
For the bosons, the Clebsch-Gordan factor for the $\nSLJ{1}{S}{0} \rightarrow \SLJ{1}{P}{1}$ is unity so the absorption cross-section is insensitive to laser polarization.
...
Not only does this make absorption imaging \Sr{87} sensitive to the initial population of the various $\nSLJfM{5s^2}{1}{S}{0}{{9}/{2}}{m_F}$ substates, the $\tau = \SI{5}{\ns}$ lifetime of the $\nSLJ{5s5p}{1}{P}{1}$ state can also lead to optical pumping effects which redistributes the $m_F$ populations for an imaging pulse of a few microseconds in duration.
