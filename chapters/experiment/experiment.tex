...
Francisco designed the main chamber was custom made by ** COMPANY? **. 
It features recessed top and bottom flanges which provide buckets for the MOT coils to fit around the 2-3/4 in top and bottom viewports. 
The bottom flange also has ** 11 ** SHV/MHV? feedthroughs which are connected to the various electric field plates. 
...
** INCLUDE PICTURE/CAD DIAGRAM OF THE BLUE AND RED MOT COILS **
** INCLUDE PICTURE/CAD DIAGRAM OF THE BLUE AND RED MOT COILS **
** INCLUDE PICTURE/CAD DIAGRAM OF THE BLUE AND RED MOT COILS **
...
\begin{figure}
	\includegraphics[width=\linewidth]{experiment/blue_system/20140829_155019.jpg}
