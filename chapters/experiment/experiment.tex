...
Keeping the working height fixed at \SI{3.5}{\inch} significantly reduced the need to build rigid supporting structures to hold both the vacuum system above the table and various elevated platforms for optics.
...
We had originally planned on mounting vertical optics directly to the main chamber but decided to mount them to the underside of the table. 
This required tapping {1/4''-20} threads on the underside of the table so that we could mount an optical breadboard.
