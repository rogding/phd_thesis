...
\begin{figure}
	...
	\caption{\label{fig:blue_MOT_20140829}
		An early picture of our \Sr{88} blue MOTs taken on 2014/08/29.
...
In order to recover atoms from the metastable reservoir, several methods have been devised which drive transitions to various excited states\footnote{
	\begin{itemize}
