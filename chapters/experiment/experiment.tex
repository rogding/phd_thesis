...
This chapter describes the Rydberg apparatus used in this thesis with the purpose of providing documentation of the current state of various systems for producing ultracold and quantum degenerate gases of strontium. 
Being the third ultracold strontium experiment at Rice, we were able to leverage lessons learned from the previous experiments, generally referred to as ``Neutral'' and ``Plasma'', to build quite a capable and flexible system.
...
In particular, we have in-vacuum electric field plates which we can use to both cancel stray electric fields as well as applying a field ionization ramp and direct the resulting electrons or ions towards the microchannel plate (MCP) detector.
...
We follow the typical laser cooling and trapping sequence for producing ultracold gases of strontium.
Detailed explanations of the various techniques and a variety of setups are available from numerous sources (e.g., \cite{Boyd2007.PhD, Stellmer2013.PhD, Stellmer2013.PRA.87.013611, Mickelson2010.PhD, Martinez2012.PhD, Barker2016.PhD, Campbell2017.PhD}) so the process will only be outlined here. 

\subsection{Cooling on the $\SI{461}{\nm}$ Transition}

Due to strontium's low vapor pressure, an oven is required to sublimate strontium to a gaseous form meaning the atoms are moving very quickly. 
...
This decay path, initially seen as a loss from the blue MOT, ends up being a powerful tool for accumulating atoms in metastable reservoir at roughly the same temperature as the blue MOT. 
