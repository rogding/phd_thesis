...
We produce strontium Rydberg atoms using a two-photon transtion where a $\SI{689}{\nm}$ and a $\SI{320}{\nm}$ photon drives transitions from the $\nSLJ{5s^2}{1}{S}{0}$ to either a $\nSLJ{5sns}{3}{S}{1}$ or $\nSLJ{5snd}{3}{D}{J}$ states. 

***********************

This section details the laser system we use to produce \SI{320}{\nm} radiation for two-photon excitation to a Rydberg state. 
Our system for generating the \SI{640}{\nm} radiation is similar to the one described in \cite{mie2014.OE.22.011182}.
