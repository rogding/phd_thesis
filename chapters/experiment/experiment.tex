...
Keeping the working height at this height significantly reduced the need to build a rigid supporting structure to hold the vacuum system above the table as well as various periscopes necessary for getting the laser beams to the height of an elevated (although using fibers would mitigate this issue with the tradeoff of less laser power to the atoms). 
...
Our system maintains ultra-high vacuum pressure using two ** \SI{40}{\liter\per\second} ** ion pumps with one on the source side and the other connected to the main chamber by high conductance flanges. 
...
We should have also used a double gate valve between the Zeeman sloewr and the source-side vacuum as we found this valve to be leaky when we initially pumped out the system\footnote{Something similar was noticed by the Weld group at UCSB and they used two gate valves to separate their atomic source from their UHV main chamber \cite{Senaratne2018.PhD}.}.
...
** Take pictures of the one Jim made? **
...
\begin{figure}[h]
	\centering
	\includesvg[keepaspectratio, width=\textwidth, height=\textheight]{experiment/magnetic_field_coils/trim_coils/trim_coils.svg}
	\caption{
...
\begin{figure}
	\includegraphics[width=\linewidth]{experiment/blue_mot/20140829_155019.jpg}
	\caption{\label{fig:blue_MOT_20140829}
...
Mention SWAP cooling? \cite{Norcia2018.NJP.20.023021, Bartolotta2018.PRA.98.023404, muniz2018.arXiv, snigirev2019.arXiv}.
