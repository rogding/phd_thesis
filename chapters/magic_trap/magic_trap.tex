...
With some concerns of heating due to off-resonant scattering of the \SI{689}{\nm} ``trap'' and ``stir'' beams, we first tested the dimple with just the trap beam (still being chopped at \SI{500}{\kHz}) in order to see how well we're able to evaporate with the dimple on.
