...
*** Add more details? ***
Based on our experiences with $\SI{60}{\um} \times \SI{60}{\um}$ crossed-beam \SI{1064}{\nm} ODT and other trap designs \cite{Stellmer2013.PRA.87.013611}, we decided to try starting with a $\SI{60}{\um} \times \SI{60}{\um}$ circular dimple propagating nearly vertically.

\subsection{Dimple Calculations}

Theoretical dimple calculations for \Sr{88} + \Sr{86} and for \Sr{84} only.

The trap dimple beam is generated from a slave laser injection locked at \SI{-1.4}{\GHz} detuned from the $\nSLJ{5s^2}{1}{S}{0} \rightarrow \nSLJ{5s5p}{3}{P}{1}$ transition in \Sr{88}. 
The cancel beam can be placed around \SI{-100}{\MHz} detuned from the same transition. 
