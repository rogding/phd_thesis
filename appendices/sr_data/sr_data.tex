...
\begin{longtable}[c]{@{}cccccccc@{}}
	...
	\toprule
	Series & $n$  & Term & {$E$ [\si{\per\cm}]} \cite{Esherick1977.PRA.15.1920} & {$E$ [\si{\per\cm}]} \cite{Beigang1982.OC.42.19} & {$E$ [\si{\per\cm}]} \cite{Dai1995.PRA.52.4416} & {$E$ [\si{\per\cm}]} \cite{Couturier2019.PRA.99.022503} & Ref. 5? \\
	\midrule
	\endfirsthead
	\multicolumn{8}{c}{\tablename\ \thetable\ -- \textit{Continued from previous page}}	\\
	\toprule
...
\begin{longtable}[c]{@{}cccccccc@{}}
	...
	\toprule
	Series & $n$  & Term & {$E$ [\si{\per\cm}]} \cite{Esherick1977.PRA.15.1920} & {$E$ [\si{\per\cm}]} \cite{Beigang1982.PS.26.183} & {$E$ [\si{\per\cm}]} \cite{Dai1995.PRA.52.4416} & {$E$ [\si{\per\cm}]} \cite{Couturier2019.PRA.99.022503} & Ref. 5? \\
	\midrule
	\endfirsthead
	\multicolumn{8}{c}{\tablename\ \thetable\ -- \textit{Continued from previous page}}	\\
	\toprule
