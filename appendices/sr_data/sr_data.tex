...
\begin{table}[H]
	\caption{\label{tab:sr_phys_prop}Some physical properties of four naturally occurring isotopes of strontium \cite{nist_edi}.}
	\centering
	\begin{tabular}{@{}cccc@{}}
		\toprule
...
\begin{table}[H]
	\caption{
		...
		Values of the fundamental constants $R_{\infty} = \SI{109737.31568508(65)}{\per\cm}$, $m_{e} = \SI{9.10938356(11)E-31}{\kg}$, and $m_u = \SI{1.660539040(20)E-27}{\kg}$ are from \cite{Mohr2016.RMP.88.035009}.}
	\centering
	\begin{tabular}{@{}cc@{}}
		\toprule
		Isotope	& $R$ {[\si{\per\cm}]}				\\
