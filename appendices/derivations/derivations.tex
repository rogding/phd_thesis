...
\begin{equation}
	Z = \int \int \exp(-\beta \epsilon)	\dd[3]{r} \dd[3]{v} = \frac{8 \pi^3}{m^3 \omega_x \omega_y \omega_z \beta^3}
\end{equation}
where $\beta = \flatfrac{1}{k_B T}$ and the integration was performed over all space and velocities.
...
\begin{equation}
	\rho\left(\bm{r}\right)
		...
		= \left(\frac{\beta m}{2 \pi}\right)^{3/2} \omega_x \omega_y \omega_z \exp[-\frac{\beta}{2} m \left(\omega_x^2 x^2 + \omega_y^2 y^2 + \omega_z^2 z^2\right)]
\end{equation}
Changing coordinates with $x^\prime = \omega_x x$, $y^\prime = \omega_y y$, $z^\prime = \omega_z z$ gives
\begin{equation}
	\rho\left(\bm{r}^\prime\right)
		= \left(\frac{\beta m}{2 \pi}\right)^{3/2} \omega_x \omega_y \omega_z \exp[-\frac{\beta}{2} m \left({x^\prime}^2 + {y^\prime}^2 + {z^\prime}^2\right)]
		= \left(\frac{\beta m}{2 \pi}\right)^{3/2} \omega_x \omega_y \omega_z \exp[-\frac{\beta}{2} m {r^\prime}^2]
\end{equation}
