...
\end{equation}
with the usual ladder operators ${\hat{J}_{\pm}=\hat{J}_{x} \pm \hat{J}_{y}}$ and ${\hat{J}_{\pm}\ket{J,m_J}=\hbar\sqrt{J\left(J+1\right)-m_J\left(m_J\pm1\right)} \ket{J,m_J\pm1}}$.
...
** segue? Maybe move this up before deriving the matrix elements for 9/2 mixing **
Using Clebsch–Gordan coefficients $\CG{J_1,m_{J_1}}{J_1,m_{J_2}}{J,m_J}=\braket{J_1,m_{J_{1}};J_2,m_{J_{2}}}{J,m_J}$, we can decompose the $\ket{F,m_F}$ states
\begin{align}
	& \ket{\left(n\SLJ{1}{S}{0}\right)F=I,m_F}		=	\sum_{m_J} \sum_{m_I} \CG{J=0,m_J=0}{I,m_I}{F=I,m_F} \ket{J=0,m_J=0} \ket{I,m_I}	= \ket{n\SLJ{1}{S}{0}} \ket{I,m_F}	\\
