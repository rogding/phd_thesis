...
For us, we use an imaging beam with a peak intensity far below the saturation intensity of the \SI{461}{\nm} transition. 
High-intensity imaging has also been used be some groups \cite{Reinaudi2007.OL.32.3143, Hueck2017.OE.25.8670, Reschovsky2017.PhD}.
...
The scattering cross section is given by ** CITE **
\begin{equation}
	\sigma = \sigma_0 \frac{\Gamma^2/4}{1+}
\end{equation}
