...
\begin{figure}[!htbp]
	\centering
	\includesvg[width=8.6cm, keepaspectratio=true]{sr_properties/sun1993.HI.78.241-87Sr+.svg}
...
\subsubsection{Why you can't drive $\SLJm{3}{P}{1}{0} \rightarrow \SLJm{3}{S}{1}{0}$ transitions}